...
int main(int argc,char** argv)
{
  ...
  //写入g2o文件,同样伪装成g2o中的顶点和边,以便用g2o_viewer查看
  //顶点
  ...
  for(gtsam::NonlinearFactor::shared_ptr factor:*graph)
  {
	...
	infoG2o.block(0,0,3,3) = info.block(3,3,3,3);   //cov rotation
        infoG2o.block(3,3,3,3) = info.block(0,0,3,3);   //cov translation   
